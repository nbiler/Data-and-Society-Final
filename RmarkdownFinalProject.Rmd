...
drug_df %>% 
  ...
  labs(title = str_wrap("Level of psycological distress in the past month vs illicit drug use in the past month for those 18-29 years old"),
       subtitle = "Level of psycological distress calculated using the K6 questions on a scale from 0-24",
       caption = "Source: NSDUH",
       x = "Level of psycological distress in the past month",
       y = "Percentage which used in the past month") +
...
drug_df %>% 
  ...
  labs(title = str_wrap("Illicit drug use in the past month vs average level of psycological distress for those 18-29 years old"),
       subtitle = "Level of psycological distress calculated using the K6 questions on a scale from 0-24",
       caption = "Source: NSDUH",
...
drug_df %>% 
  ...
  labs(title = "Illicit drug use in the past month vs poverty level",
       x = "Poverty level",
       y = "Percentage of individuals who used illicit drugs in past month",
       caption = "Source: NSDUH") +
